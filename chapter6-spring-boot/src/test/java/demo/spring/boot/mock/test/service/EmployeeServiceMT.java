...
public class EmployeeServiceMT {
	...
	public void setUp() {
		...
		prepareMockTestRuleEmployeeQueryByEmpNo();
		prepareMockTestRuleEmployeeProfiles();
	}
	
	@Test
	public void queryEmployee() {
		
		Employee emp = employeeService.findByEmpNo(11L);
	...
	public void saveEmployee() {
		...
		prepareMockTestRuleEmployeeSave(empContext);
